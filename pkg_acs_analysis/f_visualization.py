...
def plot_ratio_ordered(sex_full):
    ...
    plt.savefig(
        "images/Wage_Ratio_Ordered.png", bbox_inches="tight", pad_inches=0.2, dpi=300
    )
...
def plot_sex_n_cat(yearly_sex_sep):
    ...
    plt.savefig(
        "images/Wage_Category_Plot.png", bbox_inches="tight", pad_inches=0.2, dpi=300
    )
...
def plot_heatmap_lineplot(cat_full, yearly_sex_full, var):
    ...
    fig.savefig(path, bbox_inches="tight", pad_inches=0.2, dpi=300)
